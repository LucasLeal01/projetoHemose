...
function MedicamentosPage() {
  ...
  useEffect(() => {
    ...
    const mockMedicamentos: Medicamento[] = [
      { id: 1, paciente: 'Fernanda Dias', leito: '301A', medicamento: 'Paracetamol', dosagem: '500mg', horario: '08:00' },
      { id: 2, paciente: 'José Martins', leito: '302B', medicamento: 'Amoxicilina', dosagem: '250mg', horario: '12:00' },
      { id: 3, paciente: 'Paula Souza', leito: '303C', medicamento: 'Dipirona', dosagem: '1g', horario: '18:00' },
    ]
  ...
  return (
    <main className="p-6 bg-green-50 min-h-screen">
      <h1 className="text-3xl font-bold text-green-800 mb-6">Administração de Medicamentos</h1>
