...
function TriagemPage() {
  ...
  useEffect(() => {
    ...
    const mockTriagem: PacienteTriagem[] = [
      { id: 1, nome: 'Ana Paula', leito: '201A', prioridade: 'Alta', queixa: 'Dor intensa no peito' },
      { id: 2, nome: 'Pedro Lima', leito: '202B', prioridade: 'Média', queixa: 'Febre e tosse' },
      { id: 3, nome: 'Luiza Costa', leito: '203C', prioridade: 'Baixa', queixa: 'Dor de cabeça' },
    ]
...
export default withAuth(TriagemPage)
