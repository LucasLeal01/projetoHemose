...
function SinaisVitaisPage() {
  ...
  const [updatedSinal, setUpdatedSinal] = useState<{ pressao: string; frequencia: string; temperatura: string }>({
    pressao: '',
    frequencia: '',
    temperatura: '',
  })
  ...
  useEffect(() => {
    const mockSinais: SinalVital[] = [
      { id: 1, paciente: 'Marcos Silva', leito: '501A', pressao: '120/80', frequencia: '75 bpm', temperatura: '36.7 °C', dataHora: '25/05/2025 08:00' },
      { id: 2, paciente: 'Rafaela Mendes', leito: '502B', pressao: '130/85', frequencia: '82 bpm', temperatura: '37.1 °C', dataHora: '25/05/2025 09:30' },
      { id: 3, paciente: 'Cláudia Rocha', leito: '503C', pressao: '110/70', frequencia: '68 bpm', temperatura: '36.4 °C', dataHora: '25/05/2025 10:15' },
    ]
  ...
  const handleConfirm = () => {
    ...
    const now = new Date()
    const formattedDate = now.toLocaleDateString('pt-BR') + ' ' + now.toLocaleTimeString('pt-BR').slice(0, 5)
              ...
              <tr key={sinal.id} className="border-b hover:bg-green-100">
                ...
                <td className="py-3 px-6">
                  <button
                    ...
                    onClick={(e) =>
                      editingSinalId === sinal.id ? setEditingSinalId(null) : openMiniCard(sinal, e)
                    }
                  >
                    Registrar
                  </button>
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs text-black">
              ...
              <input
                ...
                onChange={(e) => setUpdatedSinal((prev) => ({ ...prev, pressao: e.target.value }))}
              />
            </label>
            ...
            <label className="text-xs text-black">
              ...
              <input
                ...
                onChange={(e) => setUpdatedSinal((prev) => ({ ...prev, frequencia: e.target.value }))}
              />
            </label>
            ...
            <label className="text-xs text-black">
              ...
              <input
                ...
                onChange={(e) => setUpdatedSinal((prev) => ({ ...prev, temperatura: e.target.value }))}
              />
            </label>
          </div>
...
export default withAuth(SinaisVitaisPage)
