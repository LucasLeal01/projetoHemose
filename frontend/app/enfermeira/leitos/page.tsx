...
function LeitosPage() {
  ...
  return (
    <main className="p-6 bg-green-50 min-h-screen relative">
      ...
      {editingLeitoId && miniCardPosition && (
        <div
        ...
        >
          ...
          <div className="mt-2">
            ...
            <button
              ...
              className="mt-2 bg-green-600 text-white px-2 py-1 rounded hover:bg-green-700 transition text-xs"
            >
              Confirmar Ocupação
            </button>
          </div>
...
export default withAuth(LeitosPage)
